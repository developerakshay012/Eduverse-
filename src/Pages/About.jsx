...
const About = () => {
  return (
    <div>
      <section className="bg-[#2C333F] mt-10">
        <div className="relative mx-auto flex w-11/12 max-w-315 flex-col justify-between gap-10 text-center text-white">
      ...
      <section className="border-b border-[#2e3545]">
        <div className="mx-auto flex w-11/12 max-w-315 flex-col justify-between gap-10 text-[#585D69]">
      ...
      <section>
        <div className="mx-auto flex w-11/12 max-w-315 flex-col justify-between gap-10 text-[#585D69]">
          ...
          <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
            ...
            <div className="my-24 flex lg:w-[40%] flex-col gap-10">
              <h1 className="bg-linear-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] 
