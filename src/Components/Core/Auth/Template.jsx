...
function Template({ title, description1, description2, image, formType }) {
  ...
  return (
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center max-w-315 mx-auto mt-15">
      {loading ? (
        <div className="spinner"></div>
      ) : (
        <div className="mx-auto flex w-11/12 max-w-315 flex-col-reverse justify-between gap-y-12 py-12 md:flex-row md:gap-y-0 md:gap-x-12">
