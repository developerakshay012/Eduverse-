...
const ContactUsForm = () => {
  ...
  return (
    <form
      className="flex flex-col gap-7 bg-[#161D29] p-7 rounded-md  "
    ...
    >
        ...
        <div className="flex gap-5">
          <div className="flex w-20.25 flex-col gap-2">
            <select
              ...
              id="firstname"
              placeholder=""
                className="form-style text-gray-300"
          ...
          <div className="flex w-[calc(100%-90px)] flex-col gap-2 ">
            <input
              ...
              placeholder="12345 67890"
                 className="form-style  text-gray-400"
              {...register("phoneNo", {
                required: {
                  value: true,
      ...
      <button
        disabled={loading}
        type="submit"
        className={`rounded-md bg-yellow-400 px-6 py-3 text-center text-[13px]  cursor-pointer
  font-bold text-black shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)]
  ${!loading && "hover:scale-95 hover:shadow-none"}
  disabled:bg-[#585D69] sm:text-[16px] flex items-center justify-center gap-2`}
      >
        {loading ? (
          <>
