  ...
  const SubSectionModal = ({
    ...
    const onSubmit = async (data) => {
      ...
      formData.append("courseId", course._id) // <--- FIX 1: Missing courseId
      formData.append("title", data.lectureTitle)
      formData.append("description", data.lectureDesc)
      formData.append("videoFile", data.lectureVideo) // <--- FIX 2: Backend 'videoFile' mang raha hai
      setLoading(true)
    ...
    return (
      <div className="fixed inset-0 z-1000 mt-0! grid h-screen w-screen place-items-center overflow-auto bg-transparent bg-opacity-10 backdrop-blur-md">
        <div className="my-10 w-11/12 max-w-175 rounded-lg border border-[#838894] bg-[#161D29]">
          {/* Modal Header */}
