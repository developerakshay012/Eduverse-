...
const CourseBuilderForm = () =>{
  ...
  return (
    <div className="space-y-8 rounded-md border-2 border-[#2C333F] bg-[#161D29] p-6">
      ...
      <div className="flex justify-end gap-x-3">
        <button
          onClick={goBack}
          className={`flex cursor-pointer items-center gap-x-2 rounded-md bg-[#9498a1] py-2 px-5 font-semibold text-[#23395b]`}
        >
          Back
        </button>
