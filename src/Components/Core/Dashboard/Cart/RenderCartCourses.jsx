      ...
      {cart.map((course, indx) => (
        <div
          ...
          className={`flex w-full flex-wrap items-start justify-between gap-6 ${
            indx !== cart.length - 1 && "border-b-2 border-b-[#6E727F] pb-6"
          } ${indx !== 0 && "mt-6"} `}
        >
          ...
          <div className="flex flex-col items-end space-y-2">
            <button
              ...
              className="flex items-center gap-x-1 rounded-md border border-[#424854] bg-[#2C333F] py-3 px-3 cursor-pointer text-pink-800"
            >
              <RiDeleteBin6Line />
              <span>Remove</span>
            </button>
