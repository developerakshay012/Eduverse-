...
function ChangeProfilePicture() {
  ...
  return (
    <>
      <div className="flex items-center justify-between rounded-md border-2 border-[#2C333F] bg-[#161D29] p-8 px-12 text-richblack-5">
        <div className="flex items-center gap-x-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-row gap-3">
              ...
              >
                {!loading && (
                  <FiUpload className="text-lg text-[#23395b]" />
                )}
              </IconBtn>
            </div>
          </div>
