...
const ExploreMore = () => {
  ...
  return (
    <div className=''>
      ...
      <div className='mt-5 flex flex-row rounded-full bg-[#161D29] mb-3 border-[#AFB2BF] 
      px-1 py-1'>
      {
        tabsName.map( (element, index) => {
            return (
                <div
                className={` text-[13px] lg:text-[16px] flex flex-row items-center gap-2 rounded-full
                ${currentTab === element 
                ? "bg-[#161D29] text-[#F1F2FF] font-medium"
